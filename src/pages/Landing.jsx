...
import { Car, Zap, Wallet, LayoutDashboard, ArrowRight, ShieldCheck } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 font-sans selection:bg-blue-500/30 overflow-hidden relative">
      ...
      <nav className="relative z-10 flex justify-between items-center p-6 md:px-12 max-w-7xl mx-auto">
        <div className="flex items-center gap-2">
          ...
          <span className="text-2xl font-black italic tracking-tighter uppercase text-white">FastPark</span>
        </div>
      ...
      <main className="relative z-10 flex flex-col items-center text-center pt-24 pb-32 px-6 max-w-5xl mx-auto">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800 border border-slate-700 mb-8">
          ...
          <span className="text-[10px] font-bold uppercase tracking-widest text-slate-300">Live Hackathon Demo</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
          <button 
            onClick={() => navigate('/login')} 
            className="bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-2xl font-black text-sm uppercase flex items-center justify-center gap-2 shadow-lg shadow-blue-900/40 active:scale-95 transition-all"
          >
            Register Vehicle <ArrowRight size={18} />
          </button>
          <button 
            onClick={() => navigate('/login')} 
            className="bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 px-8 py-4 rounded-2xl font-black text-sm uppercase flex items-center justify-center gap-2 active:scale-95 transition-all"
          >
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pb-32">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-slate-800 p-8 rounded-[2.5rem] border border-slate-700 hover:border-blue-500/50 transition-all group">
            ...
            <h3 className="text-xl font-black text-white mb-3 uppercase italic">Lightning OCR</h3>
          ...
          <div className="bg-slate-800 p-8 rounded-[2.5rem] border border-slate-700 hover:border-emerald-500/50 transition-all group">
            ...
            <h3 className="text-xl font-black text-white mb-3 uppercase italic">Smart Wallet</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
          ...
          <div className="bg-slate-800 p-8 rounded-[2.5rem] border border-slate-700 hover:border-purple-500/50 transition-all group">
            ...
            <h3 className="text-xl font-black text-white mb-3 uppercase italic">Admin Control</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
      ...
      {/* FOOTER */}
      <footer className="border-t border-slate-800 text-center py-8">
        <p className="text-[10px] font-bold text-slate-600 uppercase tracking-widest">
          Built for the Hackathon • FastPark System
        </p>
      </footer>
    </div>
  );
